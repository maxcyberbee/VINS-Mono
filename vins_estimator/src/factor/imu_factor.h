...
class IMUFactor : public ceres::SizedCostFunction<15, 7, 9, 7, 9>
{
  public:
    IMUFactor() = delete;
    IMUFactor(IntegrationBase* _pre_integration,rclcpp::Logger logger):pre_integration(_pre_integration),_logger(logger)
    {
    }
...
//delta_q = Qi.inverse() * Qj;
        ...
        if (jacobians)
        {
            ...
            {
                RCLCPP_WARN(this->_logger,"numerical unstable in preintegration");
