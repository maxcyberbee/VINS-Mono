...
public:
        ...
        : Node("feature_tracker")
    {
        ...
        // Subscribers
        sub_imu_forward = this->create_subscription<nav_msgs::msg::Odometry>("/vins_estimator/imu_propagate", 2000, imu_forward_callback);                    // visuallize
        sub_vio = this->create_subscription<nav_msgs::msg::Odometry>("/vins_estimator/odometry", 2000, vio_callback);                                         // visualize
        sub_image = this->create_subscription<sensor_msgs::msg::Image>("/vins_estimator/raw_image", 2000, image_callback);                                    // important
        sub_pose = this->create_subscription<snav_msgs::msg::Odometry>("/vins_estimator/keyframe_pose", 2000, pose_callback);                                 // important
        sub_extrinsic = this->create_subscription<nav_msgs::msg::Odometry>("/vins_estimator/extrinsic", 2000, extrinsic_callback);                            // important
        sub_point = this->create_subscription < sensor_msgs::msg::PointCloud >> ("/vins_estimator/keyframe_point", 2000, point_callback);                     // important
        sub_relo_relative_pose = this->create_subscription<nav_msgs::msg::Odometry>("/vins_estimator/relo_relative_pose", 2000, relo_relative_pose_callback); // important
        // Publisher
        pub_key_odometrys = this->create_publisher<visualization_msgs::msg::Marker>("restart", 1000);
        pub_camera_pose_visual = this->create_publisher<visualization_msgs::msg::Marker>("feature", 1000);
        ...
        message_filters::Subscriber<sensor_msgs::msg::Image> raw_image(this, "/pose_graph_raspberry/raw_image", 2000);
        message_filters::Subscriber<sensor_msgs::msg::PointCloud> pointcloud(this, "/pose_graph_raspberry/pointcloud", 2000);
        message_filters::Subscriber<nav_msgs::msg::Odometry> pose(this, "/pose_graph_raspberry/pose", 2000);
        message_filters::TimeSynchronizer<sensor_msgs::msg::Image, sensor_msgs::msg::PointCloud, nav_msgs::msg::Odometry> sync(raw_image, pointcloud, pose, 2000);
...
private:
    ...
    queue<sensor_msgs::msg::PointCloud> point_buf;
    ...
    rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr pub_camera_pose_visual;
    ...
    void image_callback(const sensor_msgs::ImageConstPtr &image_msg)
    {
        ...
        if (!LOOP_CLOSURE)pointcloudmsg->header.stamp.toSec());
    ...
    void imu_forward_callback(const nav_msgs::Odometry::ConstPtr &forward_msg)
    {
        if (VISUALIZE_IMU_FORWARD)
        {
            ...
            vio_t = posegraph.r_drift * vio_pointcloud
                                            Vector3d vio_t_cam;
